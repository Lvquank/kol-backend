...
-- Removes the short-lived admin-to-KOL request model introduced before the
-- public contribution flow was clarified. The table did not contain public proposals.
DROP TABLE IF EXISTS kol_gov.kol_information_requests;
